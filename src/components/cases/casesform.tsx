...
// Define interface for Case (Aligning with CaseDetail.tsx) // MIGRATION: renamed from 'Matter' to 'Case'
...
interface Case { // MIGRATION: renamed from 'Matter' to 'Case'
  ...
  caseFileName: string;
  // Add fields from CaseDetail's Case type if needed within this component, // MIGRATION: renamed from 'Matter' to 'Case'
...
interface CaseDetailsProps { // MIGRATION: renamed from 'MatterDetailsProps' to 'CaseDetailsProps'
  case: Case; // MIGRATION: renamed from 'matter: Matter' to 'case: Case'
  onSave?: (updatedCase: Case) => void; // MIGRATION: renamed from 'updatedMatter: Matter' to 'updatedCase: Case'
}

import { getNotesForCase, getAllItems } from "@/services/localDbService";

export function CaseDetails({ case: caseData, onSave }: CaseDetailsProps) { // MIGRATION: renamed from 'MatterDetails' to 'CaseDetails' and 'matter' to 'case: caseData'
  ...
  const form = useForm<z.infer<typeof fullIntakeSchema>>({
    ...
    // Load default values from case.intakeForm if it exists, otherwise use defaults // MIGRATION: renamed from 'matter' to 'case'
    defaultValues: caseData.intakeForm // MIGRATION: renamed from 'matter' to 'caseData'
      ? { // If intakeForm data exists in the case prop // MIGRATION: renamed from 'matter' to 'case'
          ...caseData.intakeForm, // MIGRATION: renamed from 'matter' to 'caseData'
          // Ensure top-level fields are also correctly sourced or defaulted
          caseFileNumber: caseData.caseFileNumber || caseData.intakeForm.caseFileNumber || "", // MIGRATION: renamed from 'matter' to 'caseData'
          caseFileName: caseData.caseFileName || caseData.intakeForm.caseFileName || "", // MIGRATION: renamed from 'matter' to 'caseData'
        }
      : { // If no intakeForm data exists, provide the full default structure
          caseFileNumber: caseData.caseFileNumber || "", // MIGRATION: renamed from 'matter' to 'caseData'
          caseFileName: caseData.caseFileName || "", // MIGRATION: renamed from 'matter' to 'caseData'
          partyA: {
  ...
  // Reset form when case prop changes // MIGRATION: renamed from 'matter' to 'case'
  useEffect(() => {
    form.reset(caseData.intakeForm // MIGRATION: renamed from 'matter' to 'caseData'
      ? { // If intakeForm data exists in the case prop // MIGRATION: renamed from 'matter' to 'case'
          ...caseData.intakeForm, // MIGRATION: renamed from 'matter' to 'caseData'
          // Ensure top-level fields are also correctly sourced or defaulted
          caseFileNumber: caseData.caseFileNumber || caseData.intakeForm.caseFileNumber || "", // MIGRATION: renamed from 'matter' to 'caseData'
  ...
  }, [caseData]); // MIGRATION: renamed from 'matter' to 'caseData'
  ...
  function onSubmit(data: z.infer<typeof fullIntakeSchema>) {
    ...
    // Update the case with the intake form data // MIGRATION: renamed from 'matter' to 'case'
    const updatedCase = { // MIGRATION: renamed from 'updatedMatter' to 'updatedCase'
      ...caseData, // MIGRATION: renamed from 'matter' to 'caseData'
      intakeForm: data,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
              ...
              <div className="space-y-4">
                ...
                <Accordion type="multiple" className="w-full space-y-3">
                  ...
                  <AccordionItem value="legalQuestions-a" className="border-b-0">
                    ...
                    <AccordionContent className="space-y-4 px-3 pt-3">
                      {/* Form fields for legal questions... */}
                      <FormField
                        control={form.control}
              ...
              <div className="space-y-4">
                ...
                <Accordion type="multiple" className="w-full space-y-3">
                  ...
                  <AccordionItem value="personalDetails-b" className="border-b-0">
                    ...
                    <AccordionContent className="space-y-4 px-3 pt-3">
                      {/* Party B personal details form fields... */}
                      <FormField
                        control={form.control}
                        name="partyB.name"
                        render={({ field }) => (
                  ...
                  {/* Other sections for Party B... */}
                  {/* Legal Questions - B, Work Details - B, Finance Details - B */}
                  {/* Similar structure as Party A */}
                </Accordion>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <Accordion type="multiple" className="w-full space-y-3">
                ...
                {/* Other arrangement sections... */}
                {/* Future Needs, Maintenance Arrangements, Educational Costs */}
              </Accordion>
            </div>
