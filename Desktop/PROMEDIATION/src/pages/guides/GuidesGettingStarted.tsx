    ...
    <Layout>
      <div className={`flex flex-col ${isMobile ? "space-y-4" : "space-y-6"} p-4 md:p-6`}>
        ...
        <div className="mb-4 md:mb-6">
          <Card>
            <CardContent className="p-4"> {/* Explicit uniform padding */}
              <div
                style={{
                  // width: '100%', // Block element default
              ...
              >
                <video
                  ...
                  style={{
                    ...
                    width: '100%',       // Fill containing div
                    height: 'auto',      // Maintain aspect ratio
                    maxHeight: '75vh',   // Prevent excessive height (adjust as needed)
                    borderRadius: 'inherit', // Match container's border radius
                  }}
                >
